#!/usr/bin/env python3
"""Freeze the current Tier A dataset as a baseline snapshot."""
...
DATASET_PATH = PROJECT_ROOT / "public" / "data" / "tier-a.json"
BASELINES_DIR = PROJECT_ROOT / "baselines"
PUBLIC_META_PATH = PROJECT_ROOT / "public" / "data" / "tier-a-baseline.meta.json"
...
def main() -> None:
    ...
    snapshot_name = f"tier-a-baseline-{stamp}.json"
    snapshot_path = BASELINES_DIR / snapshot_name
    latest_path = BASELINES_DIR / "tier-a-baseline.latest.json"
    ...
    (BASELINES_DIR / "tier-a-baseline.meta.json").write_text(
