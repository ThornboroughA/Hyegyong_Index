#!/usr/bin/env python3
"""Freeze the current Tier B dataset as a baseline snapshot."""
...
DATASET_PATH = PROJECT_ROOT / "public" / "data" / "tier-b.json"
BASELINES_DIR = PROJECT_ROOT / "baselines"
PUBLIC_META_PATH = PROJECT_ROOT / "public" / "data" / "tier-b-baseline.meta.json"
...
def main() -> None:
    ...
    snapshot_name = f"tier-b-baseline-{stamp}.json"
    snapshot_path = BASELINES_DIR / snapshot_name
    latest_path = BASELINES_DIR / "tier-b-baseline.latest.json"
    ...
    (BASELINES_DIR / "tier-b-baseline.meta.json").write_text(
